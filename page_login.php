    ...
    <div class="card p-4 border-top-left-radius-0 border-top-right-radius-0">
        ...
        <form action="login.php" method="post">
            <div class="form-group">
                ...
                <input type="email" name="emailUser" id="username" class="form-control" placeholder="Эл. адрес"
                       value="">
            </div>
            <div class="form-group">
                <label class="form-label" for="password">Пароль</label>
                <input type="password" name="passwordUser" id="password" class="form-control" placeholder="">
            </div>
