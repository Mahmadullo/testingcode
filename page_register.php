                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 ml-auto mr-auto">
                            <div class="card p-4 rounded-plus bg-faded">
                                  ...
                                  <div class="alert <?php echo $_SESSION['alert']; ?> text-dark" role="alert">
                                      <strong>Уведомление!</strong> <?php
															...
															<?php endif; ?>
                                <form id="js-login" novalidate="" action="check_register.php" method="post">
                                    <div class="form-group">
                                        <label class="form-label" for="emailverify">Email</label>
                                        <input type="email" name="userEmail" id="emailverify" class="form-control"
                                    ...
                                    <div class="row no-gutters">
                                        <div class="col-md-4 ml-auto text-right">
                                            <button id="js-login-btn" name="submit" type="submit"
